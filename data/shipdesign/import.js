...
// Nodes
const nodes = require(__dirname + "/nodesship.json");
...
// Edges
const edges = require(__dirname + "/edgesship.json");
db.WITHINLCPHASE.save(edges["within_LCphase"]);
db.DUEBYMONTH.save(edges["due_bymonth"]);
db.PARTOF.save(edges["part_of"]);
db.ASSIGNEDTO.save(edges["assigned_to"]);
db.MEMBEROF.save(edges["member_of"]);
db.BASEDAT.save(edges["based_at"]);
